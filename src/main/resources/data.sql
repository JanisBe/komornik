INSERT IGNORE INTO komornik.users (id, avatar, mail, name, password)
...
INSERT IGNORE INTO komornik.categories (id, name)
VALUES (1, 'kategoria');
INSERT IGNORE INTO komornik.categories (id, name)
VALUES (2, 'drugaKategoriaaa');
INSERT IGNORE INTO komornik.groups (id, default_currency, description, name)
VALUES (1, 'PLN', 'komornik grupa', 'grupa');
INSERT IGNORE INTO komornik.groups (id, default_currency, description, name)
VALUES (2, 'PLN', null, 'drugaKategoriaaa');
INSERT IGNORE INTO komornik.user_x_group (group_id, user_id)
VALUES (1, 1);
INSERT IGNORE INTO komornik.user_x_group (group_id, user_id)
VALUES (1, 2);
INSERT IGNORE INTO komornik.user_x_group (group_id, user_id)
...
INSERT IGNORE INTO komornik.user_x_group (group_id, user_id)
VALUES (2, 3);
INSERT IGNORE INTO komornik.expenses (id, currency, date, description, note, category_id, group_id)
...
INSERT IGNORE INTO komornik.debts (id, amount, expense_id, from_user_id, to_user_id)
