...
INSERT IGNORE INTO test.categories (id, name)
VALUES (1, 'kategoria');
INSERT IGNORE INTO test.categories (id, name)
...
INSERT IGNORE INTO test.user_x_group (group_id, user_id)
VALUES (2, 3);
INSERT IGNORE INTO test.expenses (id, currency, date, description, note, category_id, group_id)
...
INSERT IGNORE INTO test.debts (id, amount, expense_id, from_user_id, to_user_id)
